...
const smsConfigService_1 = require("../services/smsConfigService");
const adminAuth_1 = require("../middleware/adminAuth");
const router = express_1.default.Router();
const smsConfigService = new smsConfigService_1.SMSConfigService();
...
router.put('/:id', async (req, res) => {
    try {
        ...
        if (req.body.connectionString !== undefined)
            updates.connectionString = req.body.connectionString;
        ...
        if (req.body.environment !== undefined)
            updates.environment = req.body.environment;
